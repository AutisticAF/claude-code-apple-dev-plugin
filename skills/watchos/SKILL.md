...
|  -> references/widgets-for-watch.md
...
| File | Content |
|------|---------|
| [references/watch-connectivity.md](references/watch-connectivity.md) | iPhone <-> Watch sync, session management, data transfer, offline caching |
| [references/complications.md](references/complications.md) | ClockKit to WidgetKit migration, complication families, timeline providers, gauges |
| [references/health-fitness.md](references/health-fitness.md) | HealthKit, workout sessions, heart rate, Extended Runtime, route tracking, privacy |
| [references/widgets-for-watch.md](references/widgets-for-watch.md) | Smart Stack widgets, relevance, cross-platform sharing, watchOS design |
