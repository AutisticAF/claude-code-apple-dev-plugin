...
- **references/launch-optimization.md** — App launch phases, cold/warm start optimization
- **references/energy-diagnostics.md** — Battery, thermal state, network efficiency
