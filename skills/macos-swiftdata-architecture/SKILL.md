...
- Query patterns (see references/query-patterns.md)
- Repository pattern (see references/repository-pattern.md)
...
1. **Schema Design**: `references/schema-design.md`
   - @Model design and attributes
   - Relationships and cascade rules
   - Unique constraints and indexes

2. **Query Patterns**: `references/query-patterns.md`
   - @Query in SwiftUI views
   - FetchDescriptor for services
   - Predicates, sorting, pagination

3. **Repository Pattern**: `references/repository-pattern.md`
   - Protocol-based abstraction
   - Dependency injection
   - Testing with mock repositories

4. **Performance**: `references/performance.md`
   - Batch operations
   - Background contexts
   - Memory optimization
