...
- **references/hig-checklist.md** - Comprehensive HIG compliance checklist for iOS and watchOS
- **references/font-guidelines.md** - Font usage, Dynamic Type, and typography best practices
- **references/accessibility-quick-ref.md** - Quick reference for accessibility implementation
