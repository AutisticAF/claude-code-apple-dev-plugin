...
Load and apply: **references/secure-storage.md**
...
Load and apply: **references/biometric-auth.md**
...
Load and apply: **references/network-security.md**
...
Load and apply: **references/platform-specifics.md**
...
- **references/secure-storage.md** - Keychain, Data Protection, Secure Enclave
- **references/biometric-auth.md** - Face ID, Touch ID, LAContext
- **references/network-security.md** - ATS, certificate pinning, TLS
- **references/platform-specifics.md** - iOS vs macOS vs watchOS
