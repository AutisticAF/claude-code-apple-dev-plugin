# Swift 6.2 Concurrency Updates (Approachable Concurrency)
...
## 5. Migration Guide: Swift 6.0/6.1 to Swift 6.2
...
- [Apple: Swift Concurrency Updates](https://developer.apple.com/documentation/swift/concurrency)
