...
- `references/coredata-to-swiftdata.md` -- NSManagedObject to @Model, migration stages, coexistence
- `references/uikit-to-swiftui.md` -- UIHostingController, Representable, incremental adoption
- `references/observable-migration.md` -- @Observable macro, @Environment injection, AsyncSequence
- `references/objc-to-swift.md` -- Bridging headers, @objc, incremental file-by-file migration
- `references/storekit-migration.md` -- StoreKit 2 async/await purchases, Transaction.currentEntitlements, JWS
- `references/xctest-to-swift-testing.md` -- @Test, #expect, #require, parameterized tests
