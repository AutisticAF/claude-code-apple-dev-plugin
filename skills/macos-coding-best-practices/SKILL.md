---
name: macos-coding-best-practices
...
- Swift language patterns (see references/swift-language.md)
- Architecture principles (see references/architecture-principles.md)
- Data persistence approach (see references/data-persistence.md)
- Code organization (see references/code-organization.md)
- Concurrency usage (see references/modern-concurrency.md)
...
1. **Swift Language**: `references/swift-language.md`
   - Modern Swift 6+ features
   - Value vs reference types
   - Protocol-oriented programming

2. **Architecture Principles**: `references/architecture-principles.md`
   - SOLID principles with examples
   - DRY principle
   - Clean Architecture patterns

3. **Data Persistence**: `references/data-persistence.md`
   - SwiftData best practices
   - Core Data (when needed)
   - Migration strategies

4. **Code Organization**: `references/code-organization.md`
   - Modular architecture
   - Feature vs layer organization
   - Package structure

5. **Modern Concurrency**: `references/modern-concurrency.md`
