---
name: generators-featuring-nomination
...
Read `references/nomination-template.md` for the angle selection framework.
...
Read `references/nomination-template.md` and fill all fields.
...
- **references/nomination-template.md** — Detailed nomination form and angle framework
