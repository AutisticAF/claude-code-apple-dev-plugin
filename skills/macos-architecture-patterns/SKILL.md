---
name: macos-architecture-patterns
...
- SOLID principles (see references/solid-detailed.md)
- Design patterns (see references/design-patterns.md)
- Code organization (see references/modular-design.md)
...
1. **SOLID Principles**: `references/solid-detailed.md`
...
3. **Modular Design**: `references/modular-design.md`
