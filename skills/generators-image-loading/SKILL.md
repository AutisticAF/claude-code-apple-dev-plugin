...
Read `references/image-loading-patterns.md` for architecture guidance.
...
- **references/image-loading-patterns.md** — Why not AsyncImage, NSCache config, LRU disk cache, deduplication
