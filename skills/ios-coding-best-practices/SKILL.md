---
name: ios-coding-best-practices
...
Before starting the review, familiarize yourself with the reference patterns by reading the following files:

- **references/swift-patterns.md** - Optionals, type safety, collections, error handling, naming
- **references/swiftui-patterns.md** - State management, view composition, performance
- **references/architecture-patterns.md** - MVVM, code organization, memory management, security
- **references/coredata-patterns.md** - Core Data best practices, fetching, saving, relationships
