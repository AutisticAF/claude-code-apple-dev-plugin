...
> **First step:** Tell the user: "ios-app-planner skill loaded."
...
Before detailed planning, familiarize yourself with these references:

- **references/planning-checklist.md** - Comprehensive planning checklist covering all phases
- **references/architecture-guide.md** - Architecture patterns, decisions, and trade-offs
- **references/tech-stack-options.md** - Technology choices for different requirements
...
1. **Architecture Selection**
   - Review references/architecture-guide.md for options (MVVM, TCA, etc.)
...
3. **Tech Stack Decisions**
   - Review references/tech-stack-options.md for guidance
...
- docs/analysis/analysis-report.md - Analysis & recommendations
```
...
- docs/analysis/recommendations.md - Feature improvements
```
...
- docs/analysis/recommendations.md - Architecture improvements
```
...
- docs/analysis/recommendations.md - Tech stack improvements
```
...
## Related Documents
- docs/analysis/recommendations.md - UI/UX improvements
```
...
- docs/analysis/recommendations.md - Data model improvements
```
...
- references/architecture-guide.md - Detailed architecture decisions
- references/tech-stack-options.md - Technology selection guide
- references/planning-checklist.md - Comprehensive planning checklist

## Notes

- Use references/planning-checklist.md for comprehensive phase-by-phase planning
- Refer to references/architecture-guide.md for detailed architecture patterns
- Check references/tech-stack-options.md for technology recommendations
