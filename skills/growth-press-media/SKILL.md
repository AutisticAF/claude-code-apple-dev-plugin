...
See **references/pitch-templates.md** for:
...
## Pitch Drafts
[See references/pitch-templates.md for templates, customize for each contact]
```

## References

- **references/pitch-templates.md** — Email templates for all pitch types
