---
name: macos-appkit-swiftui-bridge
...
- NSViewRepresentable usage (see references/nsviewrepresentable.md)
- Hosting controllers (see references/hosting-controllers.md)
...
1. **NSViewRepresentable**: `references/nsviewrepresentable.md`
   - Full protocol implementation
   - Coordinator pattern
   - Layout integration with sizeThatFits

2. **Hosting Controllers**: `references/hosting-controllers.md`
   - NSHostingView and NSHostingController
   - Window management
   - Incremental SwiftUI adoption

3. **State Management**: `references/state-management.md`
   - @Observable bridging
   - Combine pipelines
