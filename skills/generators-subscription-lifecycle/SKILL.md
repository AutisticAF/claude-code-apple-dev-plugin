---
name: generators-subscription-lifecycle
...
- **references/patterns.md** — Lifecycle state diagrams, StoreKit 2 behavior reference, anti-patterns
- Related: `generators-paywall-generator` — Purchase UI and initial transaction handling
- Related: `monetization` — Pricing tiers and revenue planning
