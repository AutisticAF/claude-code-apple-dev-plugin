...
- Liquid Glass design implementation (see references/liquid-glass-design.md)
- macOS Tahoe HIG compliance (see references/macos-tahoe-hig.md)
- SwiftUI patterns for macOS (see references/swiftui-macos.md)
- AppKit modernization (see references/appkit-modern.md)
- Accessibility standards (see references/accessibility.md)
...
1. **Liquid Glass Design**: `references/liquid-glass-design.md`
   - Design language principles
   - Visual hierarchy and depth
   - Transparency and materials
   - Animation guidelines

2. **macOS Tahoe HIG**: `references/macos-tahoe-hig.md`
   - Human Interface Guidelines
   - Platform conventions
   - Window management
   - Toolbar and menu design

3. **SwiftUI for macOS**: `references/swiftui-macos.md`
   - SwiftUI patterns and components
   - macOS-specific modifiers
   - Known Tahoe SwiftUI issues
   - Layout best practices

4. **AppKit Modernization**: `references/appkit-modern.md`
