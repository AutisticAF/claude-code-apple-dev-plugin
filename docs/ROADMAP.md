...
| Photo library access, PhotosPicker, PHPhotoLibrary | `photokit` | ✅ Complete |
| Health data, workout sessions, background delivery | `healthkit` | ✅ Complete |
| Apple Pay, payment processing, Wallet passes | `passkit` | ✅ Complete |
| Calendar events, reminders, EventKitUI | `eventkit` | ✅ Complete |
| Apple Music integration, ShazamKit | `musickit` | ✅ Complete |
| Weather data, forecasts, alerts, attribution | `weatherkit` | ✅ Complete |
| ARKit world/face/image tracking, RealityKit entities | `arkit` | ✅ Complete |
...
All skills use a flat directory structure under `skills/`:
...
| Prefix | Count | Skills |
|--------|-------|--------|
| app-store | 7 | app-store-app-description-writer, app-store-apple-search-ads, app-store-keyword-optimizer, app-store-marketing-strategy, app-store-rejection-handler, app-store-review-response-writer, app-store-screenshot-planner |
| apple-intelligence | 3 | apple-intelligence-app-intents, apple-intelligence-foundation-models, apple-intelligence-visual-intelligence |
| design | 2 | design-animation-patterns, design-liquid-glass |
| generators | 63 | generators (overview), generators-accessibility-generator, generators-account-deletion, generators-analytics-setup, generators-announcement-banner, generators-app-clip, generators-app-extensions, generators-app-icon-generator, generators-app-store-assets, generators-auth-flow, generators-background-processing, generators-ci-cd-setup, generators-cloudkit-sync, generators-consent-flow, generators-custom-product-pages, generators-data-export, generators-debug-menu, generators-deep-linking, generators-error-monitoring, generators-feature-flags, generators-featuring-nomination, generators-feedback-form, generators-force-update, generators-http-cache, generators-image-loading, generators-in-app-events, generators-lapsed-user, generators-live-activity-generator, generators-localization-setup, generators-logging-setup, generators-milestone-celebration, generators-networking-layer, generators-offer-codes-setup, generators-offline-queue, generators-onboarding-generator, generators-pagination, generators-paywall-generator, generators-permission-priming, generators-persistence-setup, generators-pre-orders, generators-product-page-optimization, generators-promoted-iap, generators-push-notifications, generators-quick-win-session, generators-referral-system, generators-review-prompt, generators-screenshot-automation, generators-settings-kit, generators-share-card, generators-social-export, generators-spotlight-indexing, generators-state-restoration, generators-streak-tracker, generators-subscription-lifecycle, generators-subscription-offers, generators-test-generator, generators-tipkit-generator, generators-usage-insights, generators-variable-rewards, generators-watermark-engine, generators-whats-new, generators-widget-generator, generators-win-back-offers |
| growth | 4 | growth-analytics-interpretation, growth-community-building, growth-indie-business, growth-press-media |
| ios | 9 | ios-accessibility-audit, ios-app-planner, ios-architecture-patterns, ios-assistive-access, ios-coding-best-practices, ios-ipad-patterns, ios-migration-patterns, ios-navigation-patterns, ios-ui-review |
| legal | 1 | legal-privacy-policy |
| macos | 8 | macos-app-planner, macos-appkit-swiftui-bridge, macos-architecture-patterns, macos-capabilities, macos-coding-best-practices, macos-swiftdata-architecture, macos-tahoe-apis, macos-ui-review-tahoe |
| performance | 2 | performance-profiling, performance-swiftui-debugging |
| product | 13 | product-agent, product-architecture-spec, product-beta-testing, product-competitive-analysis, product-idea-generator, product-implementation-guide, product-implementation-spec, product-localization-strategy, product-market-research, product-prd-generator, product-release-spec, product-test-spec, product-ux-spec |
| security | 2 | security, security-privacy-manifests |
| swift | 8 | swift-cli-apps, swift-codable, swift-concurrency-patterns, swift-macros, swift-memory, swift-package-manager, swift-regex-builder, swift-testing |
| swiftdata | 2 | swiftdata-inheritance, swiftdata-patterns |
| swiftui | 11 | swiftui-alarmkit, swiftui-charts-3d, swiftui-custom-layout, swiftui-environment, swiftui-focus-management, swiftui-observable, swiftui-presentations, swiftui-text-editing, swiftui-toolbars, swiftui-transferable, swiftui-webkit |
| testing | 8 | testing-characterization-test-generator, testing-integration-test-scaffold, testing-snapshot-test-setup, testing-tdd-bug-fix, testing-tdd-feature, testing-tdd-refactor-guard, testing-test-contract, testing-test-data-factory |
| visionos | 2 | visionos-spatial-computing, visionos-widgets |
| (standalone) | 21 | arkit, avfoundation, carplay, core-ml, coretext, eventkit, foundation-attributed-string, gamekit, healthkit, mapkit-geotoolbox, monetization, multipeer-connectivity, musickit, passkit, photokit, release-review, shared-skill-creator, textkit, tvos, watchos, weatherkit |
| **Total** | **166 skill directories** | |
